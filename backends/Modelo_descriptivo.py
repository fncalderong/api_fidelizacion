                            ...
                            if sum(tipo_dato) == len(tokens):
                                ...
                                if sum(longitud_dato) == len(tokens):
                                    ...
                                    if (DATOS.shape[0] != 0):
                                        ...
                                        datos_tot['CIUDAD_PRINCIPAL']=np.where(datos_tot['CIUDAD_PRINCIPAL'].isnull(), str(00000),datos_tot['CIUDAD_PRINCIPAL'])
